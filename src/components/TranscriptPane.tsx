  ...
  />
      ...
      <div className="mt-6 p-4 bg-slate-800/30 rounded-xl border border-slate-600">
        <div className="flex items-center gap-3 mb-2">
          ...
          <span className="text-blue-200 text-sm font-semibold">Transcript Info</span>
        </div>
        <p className="text-blue-200 text-sm leading-relaxed">
          {transcript.length} final responses recorded. 
          Partial text appears in <span className="italic">italics</span> while you're speaking.
        </p>
      </div>
    </div>
  );
